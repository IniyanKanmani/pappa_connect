    ...
    return LayoutBuilder(
      ...
      return Autocomplete<String>(
        optionsBuilder: (value) async {
          List<ExtractedResult<String>> result = extractAllSorted<String>(
            query: value.text,
            choices: searchData["addresses"].cast<String>(),
            cutoff: 60,
          );

          return result.map((e) => e.choice);
        },
